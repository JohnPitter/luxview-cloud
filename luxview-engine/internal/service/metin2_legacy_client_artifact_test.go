...
func TestPatchLegacyMetin2RootData(t *testing.T) {
	...
	text := string(patched)
	for _, expected := range []string{"187.77.227.065", "PRIVATE_IP = \"187.77.227.65\"", "CH1_PORT = 13001", "MARKADDR = 13001", "AUTH_PORT = 11000"} {
...
func TestWriteLegacyMetin2ClientZipPatchesRootAndLocale(t *testing.T) {
	...
	if !strings.Contains(files["Metin2FullClient/pack/root.data"], "187.77.227.065") {
