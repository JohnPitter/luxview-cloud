...
type Config struct {
	...
	PristonClientBaseZipPath      string // Base Priston Tale 4220 client zip used to generate configured downloads
...
func Load() (*Config, error) {
	cfg := &Config{
		...
		PristonClientBaseZipPath:      envStr("PRISTON_CLIENT_BASE_ZIP", "/data/luxview/storage/_global/priston-assets/priston-4220-base.zip"),
