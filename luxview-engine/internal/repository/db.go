...
func (db *DB) migrate(ctx context.Context) error {
	...
	migrations := []string{
		...
		`CREATE INDEX IF NOT EXISTS idx_action_runs_app_created ON action_runs(app_id, created_at DESC)`,
		...
		`CREATE INDEX IF NOT EXISTS idx_action_jobs_run ON action_jobs(run_id)`,
		...
		`CREATE INDEX IF NOT EXISTS idx_action_steps_job_position ON action_steps(job_id, position)`,
		...
		`CREATE INDEX IF NOT EXISTS idx_action_secrets_app ON action_secrets(app_id, key)`,
		...
		`CREATE INDEX IF NOT EXISTS idx_action_artifacts_run ON action_artifacts(run_id, name)`,
		...
		`ALTER TABLE game_server_configs ADD COLUMN IF NOT EXISTS extra_ports JSONB NOT NULL DEFAULT '[]'`,
