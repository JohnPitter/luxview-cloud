export namespace main {
	...
	export class MuChannelMeta {
	    id: number;
	    mode: string;
	
	    static createFrom(source: any = {}) {
	        return new MuChannelMeta(source);
	    }
	...
	export class MuServerGroup {
	    group: number;
	    name: string;
	    difficulty: string;
	    channels?: MuChannelMeta[];
	
	    static createFrom(source: any = {}) {
	        return new MuServerGroup(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.channels = this.convertValues(source["channels"], MuChannelMeta);
	    }
	...
	export class GameCard {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.server_groups = this.convertValues(source["server_groups"], MuServerGroup);
