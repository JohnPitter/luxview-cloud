...
# Legacy fallback: load values from server-config.env (left by older luxview-games
# installs) ONLY for keys not already set. Engine-supplied env vars always win.
...
settings = {
    ...
    "AnnounceVampireKills":          bol("VRGAME_ANNOUNCE_VAMPIRE_KILLS", False),
    ...
    "DropTableModifier_Missions":    flt("VRGAME_DROP_RATE_MISSIONS", 1.0),
    "MaterialYieldModifier_Global":  flt("VRGAME_MATERIAL_YIELD", 1.0),
    "BloodEssenceYieldModifier":     flt("VRGAME_BLOOD_ESSENCE_YIELD", 1.0),
    "JournalQuestStacksModifier":    flt("VRGAME_JOURNAL_QUEST_STACKS", 1.0),
    "PvPVampireRespawnModifier":     flt("VRGAME_PVP_VAMPIRE_RESPAWN", 1.0),
    "CooldownModifier_Global":       flt("VRGAME_COOLDOWN_GLOBAL", 1.0),
    "SpawnRateModifier":             flt("VRGAME_SPAWN_RATE", 1.0),
